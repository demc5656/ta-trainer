...
export function ControlPanel({ setCard, reveal, answerRevealed, deck, showAddCardModal }:
  ...
  return <Col>
    <h1>Control Panel</h1>
    <div data-testid="user-list"><UserList users={users} setUsers={setUsers}></UserList></div>
    ...
    <Button data-testid="shuffle-button" onClick={shuffleUsers} className="m-4">Shuffle Users</Button>
    <Button data-testid="save-button" onClick={save} className="m-4" variant="success">Save</Button>
    <Button data-testid="new-card-button" onClick={addNewCard} className="m-4">Add new card</Button>
